...
class StageEnum(Enum):
    ...
    EXTERNAL_DETECTOR_INTEGRATION = "external_detector_integration"
    EXPERT_PRIOR_INVESTIGATION = "expert_prior_investigation"
    EXPERT_PROFILES_GENERATION = "expert_profiles_generation"
    CLUSTERING_PRIOR_INVESTIGATION = "clustering_prior_investigation"
    CLUSTERING_PROFILES_GENERATION = "clustering_profiles_generation"
    EVIDENCE_ADJUDICATION = "evidence_adjudication"
    FORENSIC_REPORT_FORMULATION = "forensic_report_formulation"
    DONE = "done"
